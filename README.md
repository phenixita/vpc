...
This project is based on Jonathan Stark's [Value Pricing Calculator](https://jonathanstark.com/vpc/) and prices a project with the **Might As Well (MAW)** or **Goldilocks** curve. It can optionally ask AI to estimate perceived value and suggest the best curve from a sanitized project brief.
